...
update_presign() {
  echo ">>> Aktualizacja: copywritingseo-presign"
  ...
  aws lambda update-function-code \
    --function-name "copywritingseo-presign" \
...
rm -rf "$TMP_DIR"
echo ""
echo "Gotowe! Lambdy zaktualizowane."
